...
function Renderer:init()
	self.order = {"GROUND","ITEMS","OBSTACLES","EFFECTS","PLAYERS","PARTICLES","WALLS","OBJECTS","HUD"}
	self.Layers = {GROUND = {},ITEMS = {},OBSTACLES = {},EFFECTS = {},PLAYERS = {},PARTICLES = {},WALLS = {},OBJECTS = {},HUD = {}} ---- objects : map objects (tree,stuff)
end
