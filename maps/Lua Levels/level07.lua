return {
  ...
  nextobjectid = 1,
  properties = {
    ["description"] = "Think carefully and dont cross the Armored enemies"
  },
  tilesets = {
    {
  ...
  layers = {
    {
      ...
      data = {
        ...
        2, 1, 1, 14, 1, 1, 8, 8, 1, 14, 1, 1, 1, 1, 2,
        2, 1, 1, 16, 1, 1, 8, 8, 1, 16, 1, 1, 1, 1, 2,
        2, 10, 1, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 11, 2,
        2, 2, 11, 2, 2, 1, 14, 1, 1, 1, 1, 1, 14, 1, 2,
        2, 1, 10, 1, 2, 1, 10, 1, 1, 1, 1, 1, 1, 1, 2,
        2, 2, 2, 11, 2, 1, 16, 1, 1, 1, 1, 1, 16, 1, 2,
