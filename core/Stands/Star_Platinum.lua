...
Star_Platinum.__index = Star_Platinum

function Star_Platinum:new()
	local t = {}
	setmetatable(t,Star_Platinum)
	return t
end
function Star_Platinum:init(player,ai)
	self.isActive = false
	self.name = "Star Platinum : The World"
	self.stand_image = love.graphics.newImage("gfx/stands/stand_Star_Platinum.png")
	self.punch_image = love.graphics.newImage("gfx/stands/Star_Platinum_punch.png")
	...
	self.special_desc = "OraOraOra"
	self.ultimate_desc = "Time Stop"
	
	-----------------------------------
	self.sounds = {}
	self.sounds.attack = love.audio.newSource("sfx/Ora_once.wav","stream")
	self.sounds.special = love.audio.newSource("sfx/OraOraOra.wav","stream")
	self.sounds.ultimate = love.audio.newSource("sfx/Star Platinum Za warudo.wav","stream")
	self.sounds.ultimate2 = love.audio.newSource("sfx/Star Platinum Za warudo Resume.wav","stream")
	--------------------
	...
	self.timestop_duration_const = 4000
	...
	self.stats = {1,1,0.5,0.8,1,0.9}
end
function Star_Platinum:setActive(active)
	self.isActive = active
end
function Star_Platinum:UltimateAttack(x,y,r)
	if self.timestop_cd == 0 then
		...
		self.sounds.ultimate:setVolume(MASTER_VOLUME)
	end
end
function Star_Platinum:SpecialAttack(x,y,r)
...
function Star_Platinum:Attack(x,y,r)
	if self.canAttack then
		...
		local p = CreateStar_Platinum_punch(nx,ny,r,self.punch_image,self.isAI)
		...
		self.sounds.attack:setVolume(MASTER_VOLUME*0.5)
	end
end
function Star_Platinum:update(dt)
...
function Star_Platinum:draw(x,y,r)
...
function CreateStar_Platinum(player,ai)
	local obj = Star_Platinum:new()
	obj:init(player,ai)
	return obj
end